...
public:
  Motor() { Motor(16, 17, 15, true, 0.07); };
  Motor(uint pin, uint dirPin, uint modePin, bool phaseMode ,float Ke) : gpio(pin), dirPin(dirPin), modePin(modePin), phaseMode(phaseMode), Ke(Ke) {
